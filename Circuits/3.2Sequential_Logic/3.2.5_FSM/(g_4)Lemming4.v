module top_module(
    ...
    parameter LEFT=3'b000,RIGHT=3'b001,groundL=3'b010,groundR=3'b011,DIGGINGL=3'b100,DIGGINGR=3'b101,SPLATTER=3'b110;
    reg [2:0] state, next_state;
    reg [4:0] splatter_count;
    ...
    always @(*) begin
        ...
        case(state)
            ...
            groundL:begin //Dig ignored
                if(splatter_count > 5'd20 && ground)next_state = SPLATTER;
        ...
        if(areset)begin
            ...
            case(next_state)
                ...
                groundL:begin
                    ...
                    if(splatter_count == 5'd21) splatter_count <= splatter_count;
                    else splatter_count <= splatter_count + 5'd1;
                end
                groundR:begin
                    {walk_left,walk_right,aaah,digging} <= {4'b0010};
                    if(splatter_count == 5'd21) splatter_count <= splatter_count;
